...
namespace Fundamental.Migrations.Fundamental
{
    ...
    [Migration("20251028142735_FixBalanceSheetDetailNaming")]
    public class FixBalanceSheetDetailNaming : Migration
    {
        /// <inheritdoc />
