...
namespace Fundamental.Migrations.Fundamental
{
    ...
    [Migration("20251028141359_FixBalanceSheetTableNameCasing")]
    public class FixBalanceSheetTableNameCasing : Migration
    {
        /// <inheritdoc />
