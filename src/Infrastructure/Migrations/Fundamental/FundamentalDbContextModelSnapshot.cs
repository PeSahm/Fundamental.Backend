...
namespace Fundamental.Migrations.Fundamental
{
    ...
    {
        /// <summary>
        /// Configures the EF Core model metadata for FundamentalDbContext used by migrations.
        /// </summary>
        /// <param name="modelBuilder">The ModelBuilder used to register annotations, enums, entity mappings, keys, relationships, owned types, indexes, and table/schema mappings that define the database schema.</param>
