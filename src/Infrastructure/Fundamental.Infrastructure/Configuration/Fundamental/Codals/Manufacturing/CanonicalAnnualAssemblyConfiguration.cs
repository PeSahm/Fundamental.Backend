...
/// <summary>
/// EF Core configuration for CanonicalAnnualAssembly entity.
/// </summary>
public class CanonicalAnnualAssemblyConfiguration : EntityTypeConfigurationBase<CanonicalAnnualAssembly>
{
    protected override void ExtraConfigure(EntityTypeBuilder<CanonicalAnnualAssembly> builder)
    {
        builder.ToTable(NpgsqlSnakeCaseNameTranslator.ConvertToSnakeCase(nameof(CanonicalAnnualAssembly)), "manufacturing");
