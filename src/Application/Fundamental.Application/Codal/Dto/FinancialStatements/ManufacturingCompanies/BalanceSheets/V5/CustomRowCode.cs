...
public static class CustomRowCode
{
    ...
    public static int Equity => 36;

    [Description("سرمايه")]
    public static int Capital => 21;

    [Description("افزایش سرمایه در جریان")]
    public static int CapitalIncreaseInProgress => 22;

    [Description("صرف سهام")]
    public static int SharePremium => 23;

    [Description("صرف سهام خزانه")]
    public static int TreasurySharePremium => 37;
    ...
    public static int ForeignOperationExchangeDifferences => 38;

    [Description("سود (زيان) انباشته")]
    public static int AccumulatedProfitLoss => 31;

    [Description("سهام خزانه")]
    public static int TreasuryShares => 24;
    ...
    public static int LongTermFinancialFacilities => 16;
    ...
    public static int TaxesPayable => 6;

    [Description("سود سهام پرداختنی")]
    public static int DividendsPayable => 7;

    [Description("تسهیلات مالی")]
    public static int FinancialFacilities => 8;
