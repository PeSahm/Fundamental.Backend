...
/// <summary>
/// تصمیمات مجمع عمومی عادی سالیانه (Canonical).
/// </summary>
public class CanonicalAnnualAssembly : BaseEntity<Guid>
{
    public CanonicalAnnualAssembly(
        Guid id,
        Symbol symbol,
        ulong traceNo,
        Uri htmlUrl,
    ...
    protected CanonicalAnnualAssembly()
    {
    }
