...
/// <summary>
/// Data structures and parsing utilities for income statement test data.
/// </summary>
public static class IncomeStatementTestData
{
    /// <summary>
    /// Represents expected income statement data from CSV files.
    /// </summary>
    public record IncomeStatementExpectation(
        int SymbolId,
        ulong TraceNo,
        string Uri,
        string Currency,
    ...
    /// <summary>
    /// Parses CSV file containing expected income statement results.
    /// </summary>
    /// <param name="csvFilePath">The path to the CSV file containing expected income statement data.</param>
    public static async Task<List<IncomeStatementExpectation>> ParseCsvExpectations(string csvFilePath)
    {
        List<IncomeStatementExpectation> expectations = new();
        ...
        for (int i = 1; i < lines.Length; i++)
        {
            ...
            bool isAudited = !string.IsNullOrWhiteSpace(fields[12]) && bool.Parse(fields[12]);
            ...
            IncomeStatementExpectation expectation = new(
                SymbolId: symbolId,
                TraceNo: traceNo,
                Uri: fields[4],
                Currency: fields[5],
