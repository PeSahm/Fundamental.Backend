### **پیوست : تصمیمات مجمع عمومی عادی سالیانه**
**نسخه شماره : 1**
**از تاریخ : 1388/22/10**

---

### **decision-AnnualAssemblyStatement (تصمیمات مجمع)**
...
| sessionOrders | (array/object) | (دستور جلسات) |
...
---
#### **assemblyInterims (اطلاعات میان دوره‌ای)**
| Field Name | Data Type | Description (Farsi) |
| :--- | :--- | :--- |
...
| Field Name | Data Type | Description (Farsi) |
| :--- | :--- | :--- |
| type | string | **نوع فیلد:** <br> `حق حضور` <br> `پاداش` <br> `حق حضور اعضای هیات مدیره عضو کمیته حسابرسی` <br> `حق حضور اعضای هیات مدیره عضو کمیته انتصابات` <br> `سایر کمیته های تخصصی` <br> `هزینه های مسولیت اجتماعی` |
